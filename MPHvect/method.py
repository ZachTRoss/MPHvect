...
def do_SVM_and_PCA_old(list1, list2, n_permutations=10, cv_folds=10, random_state=42):
    """
...
def do_SVM_and_PCA_other_old(list1, list2, n_permutations=1000, cv_folds=10, random_state=42):
    """
